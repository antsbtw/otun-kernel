...
type TUICOutboundOptions struct {
	...
	QUICOptions
	// Realm, when set, makes this TUIC outbound connect over an OTun realm
	// hole-punch (tuic-realm://) instead of dialing server/server_port. The
	// QUIC/TLS handshake runs over the punched UDP hole via overlay/tuic.
